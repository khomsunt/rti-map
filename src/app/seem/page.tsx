...
export default function seem() {
  ...
  <div className=' space-y-6'>
    ...
    <span className='flex text-green-600 justify-center text-2xl py-10'>WELCOME TO SEE M SEASON</span>

    <span className='flex text-sky-300 justify-center text-2xl'> WINTER SEASON</span>
    <div className='flex justify-center py-10 '>
